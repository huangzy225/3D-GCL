...
from trainers.GlobalCorrespondenceTrainer_stage import GlobalCorrespondenceTrainer
...
def training_loop(rank, opt):
    ...
    trainer = GlobalCorrespondenceTrainer(opt, rank, resume_epoch=iter_counter.first_epoch)
            ...
            if rank == 0:
                ...
                if iter_counter.needs_displaying():
                    ...
                    imgs = torch.cat((visualize_data['ref'].cpu(), 
                                    ...
                                    trainer.out['fake128'].data.cpu(),
                                    trainer.out['fake256'].data.cpu(),
                                    trainer.out['fake512'].data.cpu(),
